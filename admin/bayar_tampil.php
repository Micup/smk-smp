...
<table class="table table-striped table-bordered table-condensed">
  ...
  <tr>
    ...
    <td width="31" align="center"><a href="bayar_nota.php?noNota=<?php echo $myData ['kd_pembayaran'];?>" target="_blank"><i class="fa fa-print fa-lg">Nota</a></td>
    <td width="52" align="center"><a href="?page=hapus_bayar&amp;kd_pembayaran=<?php echo $myData ['kd_pembayaran'];?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENJUALAN INI ... ?')"><i class="fa fa-trash-o fa-lg"></a></td>
  </tr>
  <?php } ?>
  <tr>
