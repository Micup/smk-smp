...
$maksDat 	= ceil($jmlDat/$baris);		 ?>
  ...
  <tr>
    ...
    <td align="left"><?php echo ($myData['alamat']); ?></td>
     <td width="6%"><div align="center"><a href="?page=editsiswa&no_induk=<?php echo $myData['no_induk'];?>"><i class="fa fa-pencil-square-o fa-lg" /></a></div></td>
    <td width="48" align="center"> <a href="?page=hapus_siswa2&no_induk=<?php echo $myData['no_induk'];?> "><i class="fa fa-trash-o fa-lg" /></a></td>
