...
$max= ceil($total/$row);
  ...
  <tr>
    ...
    <td width="75" align="center"><a href="?page=editjenis&kode_jenis=<?php echo $data ['kode_jenis']; ?>" target="_self" alt="Edit Data"></a><a href="?page=editjenis&kode_jenis=<?php echo $data ['kode_jenis']; ?>"><i class="fa fa-pencil-square-o fa-lg"></i></a></td>
    <td width="70" align="center"> <a href="?page=hapus_jenis&kode_jenis=<?php echo $data['kode_jenis'];?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ?')"role="button" data-toggle="modal"><i class="fa fa-trash-o fa-lg"></i></a></td>
