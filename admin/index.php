...
<html lang="en"><head>
    ...
    <script src="../assets/admin/lib/jquery-1.11.1.min.js" type="text/javascript"></script>

        <script src="../assets/admin/lib/jQuery-Knob/js/jquery.knob.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/admin/stylesheets/temahendry.css">
    <link rel="stylesheet" type="text/css" href="../assets/admin/stylesheets/hendry.css">
...
<body class=" theme-blue">
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <a class="" href="index.html"><img src="../assets/images/logo1.png" width="239" height="54"></span></a></div>

        <div class="navbar-collapse collapse" style="height: 1px;">
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="../assets/images/logo yayasan.gif" alt="User Image" width="30" height="30" class="img-polaroid" /> </span> <?php echo $_SESSION['Admin']; ?>
    ...
    <li>
        <ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li ><a href="?page=data_pengguna"><span class="fa fa-caret-right"></span> Data Pengguna</a></li>
            <li ><a href="?page=data_siswa12"><span class="fa fa-caret-right"></span> Data Siswa</a></li>
            <li ><a href="?page=data_kelas"><span class="fa fa-caret-right"></span> Data Kelas</a></li>
    ...
    <li><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-money"></i> Transaksi Pembayaran<i class="fa fa-collapse"></i></a></li>
    <li>
    ...
    <li><a href="#" data-target=".data-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-hdd-o"></i> Cadangkan Data<i class="fa fa-collapse"></i></a></li>
    <li>
        <ul class="data-menu nav nav-list collapse">
            <li ><a href="?page=backup-data"><span class="fa fa-caret-right"></span> Back Up</a></li>
            <li ><a href="?page=restore-data"><span class="fa fa-caret-right"></span> Restore</a></li>
        </ul>
    </li>
...
<div class="row"></div>
            ...
            <footer>
                ...
                <p>© <?php echo date("Y");?> <a href="#">SMK IT ANWARUSSHOLICHIN, KRANGGAN</a></p>
          </footer>
      </div>
    </div>
