              ...
              <div id="mainContent">
                <div align="left">
                  <table width="469" height="237" border="0" cellpadding="2">
                    <tr>
                      <td width="187" rowspan="5"><div align="center"> <img src="assets/images/user.png" width="173" height="177" /></div></td>
                      <td width="190">&nbsp;</td>
                      <td width="70">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><div align="right"><button type="submit" name="login" class="btn btn-primary">Masuk..</button>
                        </div>
                      </td>
                    <td width="-4"></td>
                    </tr>
